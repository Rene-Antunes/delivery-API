...
create table grupo_permissao (grupo_id bigint not null, permissap_id bigint not null) engine=InnoDB;
create table permissao (id bigint not null auto_increment, descrição varchar(255) not null, nome varchar(255) not null, primary key (id)) engine=InnoDB;
...
alter table grupo_permissao add constraint FKopokm81dwd91gbuq26x5jja2f foreign key (permissap_id) references permissao (id);
